...
------------------------------ ---------- --------- -----------
 ...
 ca_bundle                        \+         \+     Specifies the path to a CA_BUNDLE file or directory with certificates of trusted Certificate Authorities (CAs) to be used for SSL verification.
